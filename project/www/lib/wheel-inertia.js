...
WheelInertia.prototype.update = function(delta) {
...
WheelInertia.prototype.addCallback = function(callback) {
    this.cb = callback;
}

WheelInertia.prototype.hasPeak = function() {
        // Decrement the lock.
        // console.log(this.lock, this.deltas)
        if (this.lock > 0) {
            this.lock--;
            return false;
        }
