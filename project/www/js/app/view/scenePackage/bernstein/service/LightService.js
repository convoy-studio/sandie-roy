...
define([], function() {
  ...
  LightService = (function() {
    ...
    LightService.prototype.init = function() {
      this.scene = Bernstein.Scene.scene;
    ...
    LightService.prototype.onColorStateChanged = function() {
      ...
      timescale = Bernstein.Color.state === "BLUE" || Bernstein.Color.state === "GREEN" || Bernstein.Color.state === "RED" ? 10000 : 1;
    ...
    LightService.prototype.onUpdateTween = function() {
      var vColor;
      vColor = Util.CalcAnimValue(this.pointColor, Bernstein.Color.lightColors[Bernstein.Color.state], this.anim.value);
