...
define([], function() {
  ...
  MouseService = (function() {
    ...
    MouseService.prototype.update = function() {
      ...
      this.mouseVector.unproject(Bernstein.Camera.camera);
      dir = this.mouseVector.sub(Bernstein.Camera.camera.position).normalize();
      this.raycaster.set(Bernstein.Camera.camera.position, dir);
    ...
    MouseService.prototype.normalProjection = function(dir) {
      var distance;
      distance = 3000;
      this.projection.set(Bernstein.Camera.camera.position.x, Bernstein.Camera.camera.position.y, Bernstein.Camera.camera.position.z);
