...
define(["DatParser"], function(DatParser) {
  ...
  SceneService = (function() {
    ...
    SceneService.prototype.onColorStateChanged = function() {
      ...
      timescale = Bernstein.Color.state === "BLUE" || Bernstein.Color.state === "GREEN" || Bernstein.Color.state === "RED" ? 1000000 : 1;
    ...
    SceneService.prototype.onUpdateTween = function() {
      ...
      fogVal = Util.CalcAnimValue(this.fogColor, Bernstein.Color.fogColors[Bernstein.Color.state], this.anim.value);
      skyBottomColor = Util.CalcAnimValue(this.bottomColor, Bernstein.Color.skyBottomColors[Bernstein.Color.state], this.anim.value);
      ...
      if (Bernstein.Color.state === "WHITE") {
        skyTopColor = Util.CalcAnimValue(this.topColor, Bernstein.Color.WHITE, this.anim.value);
        this.skydomeUniforms.topColor.value.setRGB(skyTopColor.r, skyTopColor.g, skyTopColor.b);
      }
      if (Bernstein.Color.state === "RED" || Bernstein.Color.state === "BLUE") {
        skyTopColor = Util.CalcAnimValue(this.topColor, Bernstein.Color.BLACK, this.anim.value);
        this.skydomeUniforms.topColor.value.setRGB(skyTopColor.r, skyTopColor.g, skyTopColor.b);
      }
    };
    ...
    SceneService.prototype.update = function() {
      this.sky.position.x = Bernstein.Camera.camera.position.x;
      this.sky.position.y = Bernstein.Camera.camera.position.y;
      this.sky.position.z = Bernstein.Camera.camera.position.z + 1000;
    };
